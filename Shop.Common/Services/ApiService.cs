namespace Shop.Common.Services
{
    ...
    string accessToken)
        ...
        public async Task<Response> GetOrdersByEmailAsync(
   string urlBase,
   string servicePrefix,
   string controller,
   string email,
   ...
   string accessToken)
        {
            try
            {
                ...
                var order = JsonConvert.DeserializeObject<List<Order>>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = order,
        ...
        public async Task<Response> GetOrdersDetailTempByEmailAsync(
   string urlBase,
   string servicePrefix,
   string controller,
   string email,
   ...
   string accessToken)
        {
            try
            {
                ...
                var order = JsonConvert.DeserializeObject<List<OrderDetailTemp>>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = order,
        ...
        public async Task<Response> PutOrderAsync(
  string urlBase,
  string servicePrefix,
  string controller,
  List<OrderDetailTemp> modelList,
  string tokenType,
  string accessToken)
        {
            try
            {
                var request = JsonConvert.SerializeObject(modelList);
                var content = new StringContent(request, Encoding.UTF8, "application/json");
                var client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
        ...
        public async Task<Response> PutOrderTempAsync(
 string urlBase,
 string servicePrefix,
 string controller,
 List<OrderDetailTemp> modelList,
 ...
 string accessToken)
    ...
    string accessToken)
        ...
        public async Task<Response> DeleteOrderItemAsync(
            string urlBase,
            string servicePrefix,
            string controller,
            int id,
        ...
        public async Task<Response> GetAllUserAsync(
   string urlBase,
   string servicePrefix,
   string controller,
   string tokenType,
   string accessToken)
        {
            try
            {
                //var request = JsonConvert.SerializeObject(new RecoverPasswordRequest { Email = "" });
                //var content = new StringContent(request, Encoding.UTF8, "application/json");
                var client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
                ...
                var user = JsonConvert.DeserializeObject<List<User>>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = user,
        ...
        public async Task<Response> GetOrdersDetailById(
            string urlBase,
            string servicePrefix,
            string controller,
            int id,
        ...
        public async Task<Response> GetOrderDetailById(
            string urlBase,
            string servicePrefix,
            string controller,
            int id,
            ...
            string accessToken)
        {
            try
            {
                ...
                var orderdetail = JsonConvert.DeserializeObject<List<OrderDetail>>(answer);
